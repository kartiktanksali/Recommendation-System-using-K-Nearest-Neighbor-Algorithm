...
# pearson NN (KNN with k=1)
# Answer should match what we saw in User Based Recommendation Systems lecture
ubfnn = UserBasedFilteringRecommender(songData)
print ("------------------------------")
print ("UBF NN Pearson Recommendations")
print ("------------------------------")
for user in songData.keys():
    print(user, ":", ubfnn.recommendKNN(user))

print ()

# pearson KNN with k=3
# Answer should match what we saw in User Based Recommendation Systems lecture
ubfknn3 = UserBasedFilteringRecommender(songData, k=3)
print ("-------------------------------------")
print ("UBF KNN (k=3) Pearson Recommendations")
print ("-------------------------------------")
for user in songData.keys():
    print(user, ":", ubfknn3.recommendKNN(user))
